...
Feature: Email a report to finance
  ...
  Scenario: the cash report contains the correct data
    Then data for the cash report should match:
      ...
      | date                | company           | membership number | statement id | membership type             | transaction type | coupon | original net price | discount | tax  | total |
  ...
  Scenario: the cash report with coupon adjustments contains the correct data
    ...
    Then data for the cash report should match:
      ...
      | 2015-02-20 11:58:58 | A J                       | II3980RK          | 47125255     | individual-supporter       | payment          | SUPERFREE | 90                 | -90      | 0   | 0     |
