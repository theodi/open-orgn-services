...
Feature: Synchronize a single updated organisation
  ...
  Scenario: Send updated organization data to observer with directory entry
    ...
    And that data tag has the following fields:
    | Description          | Homepage       | Active | Contact    | Email         | Phone           | Twitter | Linkedin                       | Facebook                      |
    | 20 seconds to comply | http://ocp.com | true   | Dick Jones | jones@ocp.com | +44 1111 222222 | ocp     | http://linkedin.com/company/ocp| http://facebook.com/pages/ocp |
