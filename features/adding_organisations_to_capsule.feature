...
Feature: Add organisation details to Capsule CRM
  ...
  Background: 
    ...
    And my organisation logo is stored at "http://stuff.theodi.org/images/acmelogo.png"
  ...
  Scenario: attach directory entry tag to existing organisation
    ...
    And that data tag should have the type "Directory entry"
    And that data tag should have a description "Lorem ipsum dolor sit amet, consectetur adipiscing elit."
    And that data tag should have an organisation url "http://www.example.com"
